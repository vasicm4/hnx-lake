...
def lambda_handler(event, context):
    ...
    try:
        ...
        all_posts = hn_posts + x_posts
        all_users = hn_users + x_users
        users_by_key = {}
        ...
        summary = f"""
            **Silver Layer Normalization Summary**
            ...
            Total Posts (after dedup): {stats['total_posts']}
            Total Users (after dedup): {stats['total_users']}
